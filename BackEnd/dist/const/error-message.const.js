...
exports.HttpResponse = {
    ...
    SESSION_REVOKED: "Session has been revoked. Please login again",
    ...
    NOT_STARTED: "The session has not started yet. Please wait until the start time.",
    SESSION_ENDED: "The session has already ended.",
    SLOT_EXIST_DAYS: (day, existing) => `You have already a slot on ${day} ${existing}`,
